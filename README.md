...
Primarily using [Niri](https://github.com/YaLTeR/niri), with some [Hyprland](https://github.com/hyprwm/Hyprland) support.

**Feel free to use and share.**

# Current Tools and Configs
- **WM**: [Niri](https://github.com/YaLTeR/niri) (primarily) & [Hyprland](https://github.com/hyprwm/Hyprland)
